...
describe('Three profile test scene', () => {
  ...
  it('captures weighted viseme writes and jaw output', () => {
    ...
    expect(jaw.rotation[0]).toBeCloseTo(0, 4);
    expect(jaw.rotation[1]).toBeCloseTo(0, 4);
    expect(jaw.rotation[2]).toBeCloseTo(18, 4);
  });
  ...
  it('captures continuum and composite bone output', () => {
    ...
    expect(negative.rotation[0]).toBeCloseTo(0, 4);
    expect(negative.rotation[1]).toBeCloseTo(-10, 4);
    expect(negative.rotation[2]).toBeCloseTo(0, 4);
    expect(positive.position).toEqual([0, 0, 0]);
    expect(positive.rotation[0]).toBeCloseTo(0, 4);
    expect(positive.rotation[1]).toBeCloseTo(5, 4);
    expect(positive.rotation[2]).toBeCloseTo(0, 4);
  });
