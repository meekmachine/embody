...
export interface LoomLargeConfig {
  ...
  /**
   * Optional animation runtime factory from `@lovelace_lol/embody/cljs`.
   * When supplied, dynamic snippet handles are owned by that runtime while
   * this engine remains the Three.js renderer connector.
   */
