...
function usage() {
  console.error([
    ...
    '',
    'Example:',
    '  node scripts/extract-humanoid-skeleton-template.cjs ../LoomLarge/frontend/public/characters/jonathan_new.glb assets/templates/jonathan-cc-base.json --id jonathan-cc-base --source-character-id jonathan --skin-name Armature',
  ].join('\n'));
}
